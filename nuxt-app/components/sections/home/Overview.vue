<template>
    <section class="p-14">
        ...
        <p class="mt-4">I have more than 5 year's experience building website for clients all over the world. <br> Below
            is a quick overview of my main technical skill sets and technologies I use.</p>
        ...
        <div class="mt-10">
            <div class="grid  xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 gap-6">
                ...
                <div class="">
                    ...
                    <p>JavaScript is my first choice. I know JavaScript more than any other programming language. And I
                        love JavaScript because JavaScript is everywhere. We can make both frontend and backend in one
                ...
                <div class="">
                    ...
                    <p>Now, this is the point where Javascript achieves superpower. We can build both frontend and
                        backend in a single language. And also can be installed in some of the popular IoT devices like
                        Raspberry Pi or Arduino. Emagine One day we will program Javascript code in robotics.</p>
                </div>
                <!-- Npm, Webpack -->
                <div class="">
                    ...
                    <p>The package manager for Node JS is very good. And Webpack and Gulp is the most popular JavaScript
                        bundler now a day. Both have very different and manageable ways to build production-ready and
                        also developer-friendly workflow.</p>
                </div>
                <!-- PHP Laravel -->
                <div class="">
                    <div class="flex items-center">
                    ...
                    <p>Besides frontend design and development I also explored the backend. But, first I learned the way
                        Node.js server works. The MVC design pattern authentication and authorization system. Connecting
                        and managing Database Etc. Then I switched to PHP Laravel framework and fallen in love with it.
                    </p>
                </div>
                <!-- HTML, CSS -->
                <div class="">
                    ...
                    <p>HTML and CSS are essential for web design and development. I have very strong understanding of
                        html, css and
                        SCSS preprocessor, flexbox, gridlayout and animation as well. In real product application We
                        mostly use Bootstrap CSS or Tailwind CSS.</p>
                </div>
                <!-- Flutter -->
                <div class="">
                    <flutter-icon></flutter-icon>
                    <h4 class="text-lg my-3 font-semibold">Mobile Apps</h4>
                    <p>I'm a front-end developer first, so I also explore some of the famous mobile app frameworks like
                        Ionic, React Native and Flutter. I personally like Flutter. </p>
                </div>
                <!-- Python -->
                <div class="">
                    ...
                    <p>I always use Git version control to manage and deploy my application. And also I have pretty good
                        experience with Github, Gitlab and Bitbucket.</p>
                </div>
            </div>
        </div>
    </section>
